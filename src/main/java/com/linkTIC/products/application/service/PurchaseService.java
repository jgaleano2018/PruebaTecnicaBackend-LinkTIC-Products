...
public class PurchaseService implements PurchaseUseCases {
    ...
    public PurchaseService(PurchaseRepositoryPort repository, InventoryClient inventoryClient){
    ...
    public Purchase create(Purchase purchase){
    	...
    	try {
    		...
    		inventoryClient.checkInventory(purchaseOptional.get().getId().toString())
